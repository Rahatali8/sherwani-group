...
export const vehicles: Vehicle[] = [
  {
    ...
    specs: [
      ...
      { label: "Engine Displacement", value: "1798 CC" },
      { label: "Seating Capacity", value: "4" },
      { label: "Engine Type", value: "Water cooled, In-lined 4 cylinders" },
      { label: "Engine Code", value: "12ZR-FE" },
      { label: "Max. Torque", value: "173/4000 Nm@Rpm" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "Max. Torque", value: "500 Nm@ 2800 Rpm" },
    ],
  },
  {
    id: 4,
    ...
    specs: [
      ...
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "2788 CC" },
      { label: "Seating Capacity", value: "5" },
      { label: "Engine Type", value: "Diesel" },
      { label: "Engine Code", value: "-" },
      { label: "Max. Torque", value: "500 Nm@ 2800 Rpm" },
...

  {
    ...
    specs: [
      { label: "Make", value: "Toyota" },
      { label: "Model", value: "COROLLA CROSS HEV" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Hybrid" },
      { label: "Engine Displacement", value: "1798 CC" },
      { label: "Seating Capacity", value: "4" },
      { label: "Engine Type", value: "Hybrid" },
      { label: "Engine Code", value: "2ZR-FXE" },
      { label: "Max. Torque", value: "142/3600" },
    ],
  },
  {
    id: 6,
    ...
    specs: [
      { label: "Make", value: "Toyota" },
      { label: "Model", value: "YARIS" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Petrol" },
      { label: "Engine Displacement", value: "1496 CC" },
      { label: "Seating Capacity", value: "5" },
      { label: "Engine Type", value: "4 Cylinders, In-Line ; 16 Valve DOHC, Dual VVT-i" },
      { label: "Engine Code", value: "2NR-FE" },
      { label: "Max. Torque", value: "	140/4200 (Nm/rpm)" },
    ],
  },
  {
    id: 7,
    ...
    specs: [
      { label: "Make", value: "Toyota" },
      { label: "Model", value: "Corolla Altis X 1.6L" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Petrol" },
      { label: "Engine Displacement", value: "1598 CC" },
      { label: "Seating Capacity", value: "4" },
      { label: "Engine Type", value: "Water cooled, In-lined 4 cylinders" },
      { label: "Engine Code", value: "1ZR-FE" },
      { label: "Max. Torque", value: "	154/5200" },
    ],
  },
  {
    id: 8,
    ...
    specs: [
      { label: "Make", value: "Toyota" },
      { label: "Model", value: "Camry Hybrid" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Hybrid" },
      { label: "Engine Displacement", value: "2487 CC" },
      { label: "Seating Capacity", value: "5" },
      { label: "Engine Type", value: "	4 Cylinders, In-Line Type, Euro 5" },
      { label: "Engine Code", value: "	A25A-FXS" },
      { label: "Max. Torque", value: "		221/5200 Nm@rpm" },
    ],
  },

  {
    ...
    specs: [
       { label: "Make", value: "Toyota" },
      { label: "Model", value: "Fortuner Legender" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "2755 CC" },
      ...
      { label: "Engine Type", value: "	Diesel" },
      { label: "Engine Code", value: "	-" },
      { label: "Max. Torque", value: " 	500 Nm @ 1600 RPM" },
    ],
  },
  {
    id: 10,
    ...
    specs: [
      ...
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "2494 CC" },
      { label: "Seating Capacity", value: "16" },
      { label: "Engine Type", value: "	4 Cylinders, In-Line, Euro II" },
      { label: "Engine Code", value: "		2KD-FTV" },
      { label: "Max. Torque", value: "	260/1600-2400 Nm/Rpm" },
    ],
  },
  {
    id: 11,
    ...
    specs: [
       { label: "Make", value: "Toyota" },
      { label: "Model", value: "HIACE DELUXE" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "2755 CC" },
      { label: "Seating Capacity", value: "12" },
      { label: "Engine Type", value: "		4 Cylinders, In-Line Type" },
      { label: "Engine Code", value: "	1GD-FTV" },
      { label: "Max. Torque", value: " 		420/1600-2200" },
    ],
  },
  {
    id: 12,
    ...
    specs: [
      ...
      { label: "Engine Displacement", value: "2755 CC" },
      { label: "Seating Capacity", value: "7" },
      { label: "Engine Type", value: "		16-valve DOHC, Chain Drive" },
      { label: "Engine Code", value: "		1GD-FTV" },
      { label: "Max. Torque", value: " 		500/1600" },
    ],
  },

  {
    ...
    specs: [
       ...
       { label: "Make", value: "Toyota" },
      { label: "Model", value: "Land Cruiser 300" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Petrol" },
      { label: "Engine Displacement", value: "3445 CC" },
      { label: "Seating Capacity", value: "7" },
      { label: "Engine Type", value: "		6 Cylinders, V6" },
      { label: "Engine Code", value: "		V35A-FTS" },
      { label: "Max. Torque", value: " 		650@ 2000-3600" },
    ],
  },
  {
    id: 14,
    ...
    specs: [
      { label: "Make", value: "Toyota" },
      { label: "Model", value: "Coaster" },
      { label: "Transmission", value: "Manual" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "4009 CC" },
      { label: "Seating Capacity", value: "29" },
      { label: "Engine Type", value: "		In-Line, 4 Cylinders" },
      { label: "Engine Code", value: "N04C-VL (EURO 2)" },
      { label: "Max. Torque", value: " 	353/1600" },
    ],
  },

  {
    ...
    specs: [
      { label: "Make", value: "Toyota" },
      { label: "Model", value: "FORTUNER GR-S" },
      { label: "Transmission", value: "Automatic" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "2755 CC" },
      { label: "Seating Capacity", value: "7" },
      { label: "Engine Type", value: "	Variable Nozzle Turbocharger INTERCOOLER" },
      { label: "Engine Code", value: "		1GD - FTV Hi with Balance Shaft" },
      { label: "Max. Torque", value: " 	500" },
    ],
  },

  {
    ...
    specs: [
       { label: "Make", value: "Toyota" },
      { label: "Model", value: " Hilux E" },
      { label: "Transmission", value: "	Manual" },
      { label: "Fuel Type", value: "Diesel" },
      { label: "Engine Displacement", value: "2755 CC" },
      { label: "Seating Capacity", value: "5" },
      { label: "Engine Type", value: "	4 cylinders, IN LINE" },
      { label: "Engine Code", value: "	1GD - FTV (Hi)" },
      { label: "Max. Torque", value: " 	420@1400-2600" },
    ],
  },
  {
    id: 17,
    ...
    specs: [
     { label: "Make", value: "Toyota" },
      ...
      { label: "Engine Type", value: "	4 cylinders, IN LINE" },
      { label: "Engine Code", value: "	2KD-FTV" },
      { label: "Max. Torque", value: " 	200@ 1400-3600" },
    ],
  },

  {
    ...
    specs: [
     { label: "Make", value: "Toyota" },
      ...
      { label: "Engine Type", value: "	4 cylinders, IN LINE" },
      { label: "Engine Code", value: "	1GD - FTV (Hi)" },
      { label: "Max. Torque", value: "450 @ 1600 - 2400" },
    ],
  },
]
          ...
          >
            {vehicles.map((vehicle) => (
              <button
                ...
                className={`min-w-[360px] flex-shrink-0 rounded-3xl border p-6 text-left shadow-[0_24px_90px_-55px_rgba(0,0,0,0.75)] md:min-w-[420px] transition ${vehicle.id === selectedId
